...
gerar_base <- function(n) {
    ...
    ##write.table(x = base, file = "../../arquivos/aula_1/base.txt",
    ...
    ##xlsx::write.xlsx(x = base, file = "../../arquivos/aula_1/base.xlsx",
    ##                 sheetName = "dados", row.names = FALSE)
}

gerar_base(384)
dados <- read.table("../../arquivos/aula_1/base.txt", header = TRUE, sep = "\t")
@
